...
const contacts = {
  propertyManager: "Amber Nash, CMCA, Portfolio Manager • Heritage Property Management Services • 500 Sugar Mill Road, Building B, Suite 200, Atlanta, GA 30350 • Main: 770-451-8171 • Direct: 770-200-8610 • anash@heritageproperty.com • www.heritageproperty.com",
...
const actionButtons = [
  { label: "Call Amber", href: "tel:7702008610", icon: Phone },
...
const knowledgeBase = [
  ...
  { category: "New Resident Tutorial", keywords: ["new resident", "new to hillside", "welcome", "move in", "first steps"], answer: "Welcome to Hillside at Lenox. Start by reviewing community rules and move-in procedures, registering your contact information with management, learning amenity access procedures, and saving the Board contact: board@hillsideatlenox.com. Amber Nash, CMCA, can help with management questions at 770-200-8610 or anash@heritageproperty.com." },
  ...
  { category: "Who To Contact", keywords: ["contact", "who do i call", "manager", "liaison", "amber", "board"], answer: "Property Manager: Amber Nash, CMCA, at anash@heritageproperty.com or 770-200-8610. Main Heritage line: 770-451-8171. Board/Community Liaison: board@hillsideatlenox.com. For emergencies, call 911 first." },
];
